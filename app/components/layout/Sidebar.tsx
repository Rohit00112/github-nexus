            ...
            {isAuthenticated ? (
              <>
                ...
                <li>
                  <Link
                    href="/auth/signout"
                    className="flex items-center space-x-2 p-2 rounded-md hover:bg-gray-700 transition-colors text-red-400 hover:text-red-300"
                    onClick={() => onClose()}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <li>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M3 3a1 1 0 011 1v12a1 1 0 01-1 1h12a1 1 0 001-1V7.414l-5-5H4a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 001-1V7.414L10.414 2H3z" clipRule="evenodd" />
                    <path fillRule="evenodd" d="M10 8a1 1 0 00-1 1v5.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 14.586V9a1 1 0 00-1-1z" clipRule="evenodd" />
                  </svg>
                  <span>Sign In</span>
                </Link>
              </li>
